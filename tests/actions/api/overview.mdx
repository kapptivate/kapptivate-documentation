...
In a **Web (New experience)** test, this is the [API Call step](/tests/actions/web/apicall): same request, plus response conditions written in the step's Checks tab and a response viewer in the builder and in the results. `ETH_HTTP_API` is what you still address in classic tests and through the [CLI](/cli/guides/create-tests) and MCP.
