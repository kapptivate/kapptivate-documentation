...
Operators cover **is exactly**, **is not exactly**, **contains**, **does not contain**, **starts with**, **ends with**, **matches JSON**, **matches regex**, **is valid JSON**, **is valid XML**, **is present**, and **is not present**. Duration fields come with a ms, seconds, or minutes picker.
